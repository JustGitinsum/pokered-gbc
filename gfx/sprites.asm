...
; RedRunSprite::           INCBIN "gfx/sprites/red_run.2bpp"    ; REMOVED, Was causing a bug: no wild battles while running. May investigate further.
GreenBikeSprite::        INCBIN "gfx/sprites/green_bike.2bpp"
GreenSprite::            INCBIN "gfx/sprites/green.2bpp"
; GreenRunSprite::        INCBIN "gfx/sprites/green_run.2bpp"   ; REMOVED, Was causing a bug: no wild battles while running. May investigate further.
