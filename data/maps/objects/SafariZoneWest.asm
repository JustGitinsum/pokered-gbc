	object_const_def
	const_export SAFARIZONEWEST_HYPER_POTION
	const_export SAFARIZONEWEST_TM_THUNDERBOLT
...
SafariZoneWest_Object:
	...
	def_object_events
	object_event  8, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_HYPER_POTION, HYPER_POTION
	object_event  9,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_TM_THUNDERBOLT, TM_THUNDERBOLT
