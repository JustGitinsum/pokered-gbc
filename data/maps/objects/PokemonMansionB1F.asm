	...
	const_export POKEMONMANSIONB1F_TM_POISON_JAB
	const_export POKEMONMANSIONB1F_TM_GLACIAL_LANCE
...
PokemonMansionB1F_Object:
	...
	object_event 19, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_POISON_JAB, TM_POISON_JAB
	object_event  5,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_GLACIAL_LANCE, TM_GLACIAL_LANCE
