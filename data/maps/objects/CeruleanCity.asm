...
CeruleanCity_Object:
	...
	def_bg_events
	bg_event  9, 21, TEXT_CERULEANCITY_SIGN
	...
	bg_event 23, 19, TEXT_CERULEANCITY_GYM_SIGN
	...
	object_event  9, 23, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_CERULEANCITY_SUPER_NERD2
	...
	object_event 28, 26, SPRITE_SLOWBRO, STAY, DOWN, TEXT_CERULEANCITY_SLOWBRO
