...
CopycatsHouse2F_Object:
	...
	object_event  4,  6, SPRITE_DODUO, WALK, LEFT_RIGHT, TEXT_COPYCATSHOUSE2F_DODUO
	object_event  7,  4, SPRITE_MEWTWO, STAY, LEFT, TEXT_COPYCATSHOUSE2F_MONSTER
	object_event  2,  0, SPRITE_MOLTRES, STAY, DOWN, TEXT_COPYCATSHOUSE2F_BIRD
	object_event  0,  5, SPRITE_MEOWTH, STAY, RIGHT, TEXT_COPYCATSHOUSE2F_FAIRY
