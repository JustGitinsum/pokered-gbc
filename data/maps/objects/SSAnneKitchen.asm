...
SSAnneKitchen_Object:
	...
	object_event 11, 13, SPRITE_COOK, STAY, NONE, TEXT_SSANNEKITCHEN_COOK5
	object_event 13,  8, SPRITE_COOK, STAY, NONE, TEXT_SSANNEKITCHEN_COOK6
	object_event  7, 12, SPRITE_COOK, STAY, UP, TEXT_SSANNEKITCHEN_COOK7
