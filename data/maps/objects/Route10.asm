...
Route10_Object:
	...
	warp_event  6, 41, POWER_PLANT, 1
	warp_event  3, 29, ROUTE_10_FOSSIL_ROOM, 1
	...
	bg_event  5, 43, TEXT_ROUTE10_POWERPLANT_SIGN
	...
	object_event  6, 27, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE10_COOLTRAINER_F1, OPP_JR_TRAINER_F, 7
