...
NameRatersHouse_Object:
	...
	object_event  1,  2, SPRITE_GAMEBOY_KID, STAY, DOWN, TEXT_NAMERATERSHOUSE_MOVE_RELEARNER
	object_event  6,  1, SPRITE_GAMEBOY_KID, STAY, DOWN, TEXT_NAMERATERSHOUSE_MOVE_DELETER
