...
CinnabarLabFossilRoom_Object:
	...
	def_object_events
	object_event  6,  2, SPRITE_SCIENTIST, STAY, UP, TEXT_CINNABARLABFOSSILROOM_SCIENTIST1
	object_event  7,  6, SPRITE_SCIENTIST, STAY, LEFT, TEXT_CINNABARLABFOSSILROOM_SCIENTIST2
