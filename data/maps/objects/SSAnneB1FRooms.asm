	...
	const_export SSANNEB1FROOMS_TM_ICE_FANG
	const_export SSANNEB1FROOMS_HYPER_POTION
...
SSAnneB1FRooms_Object:
	...
	object_event 11, 12, SPRITE_MACHOKE, STAY, NONE, TEXT_SSANNEB1FROOMS_MACHOKE
	object_event 20,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNEB1FROOMS_ETHER, ETHER
	object_event 10,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNEB1FROOMS_TM_ICE_FANG, TM_ICE_FANG
	object_event 12, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNEB1FROOMS_HYPER_POTION, HYPER_POTION
