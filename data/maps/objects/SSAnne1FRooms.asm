	...
	const_export SSANNE1FROOMS_TM_FIRE_FANG
...
SSAnne1FRooms_Object:
	...
	object_event 22,  1, SPRITE_NURSE, STAY, DOWN, TEXT_SSANNE1FROOMS_NURSE
	...
	object_event  3, 11, SPRITE_WIGGLYTUFF, STAY, DOWN, TEXT_SSANNE1FROOMS_WIGGLYTUFF
	object_event 10, 13, SPRITE_GIRL, STAY, RIGHT, TEXT_SSANNE1FROOMS_GIRL2
	object_event 12, 15, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNE1FROOMS_TM_FIRE_FANG, TM_FIRE_FANG
