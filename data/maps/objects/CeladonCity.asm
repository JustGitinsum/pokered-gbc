...
CeladonCity_Object:
	...
	warp_event 41, 27, CELADON_HOTEL, 1

	def_bg_events
	bg_event 35, 15, TEXT_CELADONCITY_TRAINER_TIPS1
	bg_event 19, 15, TEXT_CELADONCITY_SIGN
	bg_event 42,  9, TEXT_CELADONCITY_POKECENTER_SIGN
	bg_event 15, 29, TEXT_CELADONCITY_GYM_SIGN
	...
	object_event 30, 12, SPRITE_POLYWRATH, STAY, RIGHT, TEXT_CELADONCITY_POLIWRATH
