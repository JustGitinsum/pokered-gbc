...
Route6_Object:
	...
	warp_event 17,  7, UNDERGROUND_PATH_ROUTE_6, 1

	def_bg_events
	bg_event 17,  9, TEXT_ROUTE6_UNDERGROUND_PATH_SIGN

	def_object_events
	object_event 10, 17, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_ROUTE6_COOLTRAINER_M1, OPP_JR_TRAINER_M, 4
	object_event 11, 17, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE6_COOLTRAINER_F1, OPP_JR_TRAINER_F, 2
	object_event  0, 26, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_ROUTE6_YOUNGSTER1, OPP_BUG_CATCHER, 10
	...
	object_event 19, 20, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_ROUTE6_YOUNGSTER2, OPP_BUG_CATCHER, 11
