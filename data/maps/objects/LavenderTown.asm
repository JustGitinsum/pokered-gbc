...
LavenderTown_Object:
	...
	warp_event  1, 13, LAVENDER_CUBONE_HOUSE, 1
	warp_event  9, 13, NAME_RATERS_HOUSE, 1

	def_bg_events
	bg_event  9,  1, TEXT_LAVENDERTOWN_SIGN
	bg_event  7, 13, TEXT_LAVENDERTOWN_NAMER_RELEARNER_DELETER_SIGN
	...
	bg_event 15,  7, TEXT_LAVENDERTOWN_POKEMON_TOWER_SIGN
