	...
	const_export SAFARIZONEEAST_HYPER_POTION
	const_export SAFARIZONEEAST_CARBOS
	const_export SAFARIZONEEAST_TM_ICE_BEAM
...
SafariZoneEast_Object:
	...
	object_event  3,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_HYPER_POTION, HYPER_POTION
	object_event 20, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_CARBOS, CARBOS
	object_event 15, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_TM_ICE_BEAM, TM_ICE_BEAM
