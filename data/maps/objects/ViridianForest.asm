...
ViridianForest_Object:
	...
	def_bg_events
	bg_event 22, 40, TEXT_VIRIDIANFOREST_TRAINER_TIPS1
	...
	def_object_events
	object_event 27, 41, SPRITE_YOUNGSTER, STAY, NONE, TEXT_VIRIDIANFOREST_YOUNGSTER1
	...
	object_event 24,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_FULL_HEAL, FULL_HEAL
	object_event 12, 29, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_POTION, POTION
	object_event  2, 31, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_POKE_BALL, POKE_BALL
	object_event 16, 41, SPRITE_NURSE, STAY, NONE, TEXT_VIRIDIANFOREST_NURSE
