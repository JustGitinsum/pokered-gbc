	...
	const_export ROCKETHIDEOUTB4F_TM_AIR_SLASH
...
RocketHideoutB4F_Object:
	...
	object_event 25,  6, SPRITE_JAMES, STAY, DOWN, TEXT_ROCKETHIDEOUTB4F_JAMES
	object_event 24,  6, SPRITE_JESSIE, STAY, DOWN, TEXT_ROCKETHIDEOUTB4F_JESSIE
	...
	object_event 12, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_TM_AIR_SLASH, TM_AIR_SLASH
	object_event  9,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_IRON, IRON
