...
; SPRITESET_PEWTER_CERULEAN
	...
	db SPRITE_HIKER
	db SPRITE_SLOWBRO ;SPRITE_MONSTER
	db SPRITE_BLUE
	db SPRITE_GUARD
...
; SPRITESET_VERMILION
	...
	db SPRITE_YOUNGSTER
	db SPRITE_GAMBLER
	db SPRITE_MACHOP ;SPRITE_MONSTER
	db SPRITE_OFFICER_JENNY ;SPRITE_GUARD
	db SPRITE_SAILOR
	db SPRITE_COOLTRAINER_F
	db SPRITE_COOLTRAINER_M
	db SPRITE_POKE_BALL
...
; SPRITESET_CELADON
	...
	db SPRITE_GRAMPS
	db SPRITE_POLYWRATH ;SPRITE_MONSTER
	db SPRITE_GUARD
	db SPRITE_ROCKET
	db SPRITE_POKE_BALL
	db SPRITE_SNORLAX
...
; SPRITESET_FUCHSIA
	db SPRITE_SLOWPOKE   ; BIRD
	db SPRITE_COOLTRAINER_F
	db SPRITE_CHANSEY     ; FAIRY
	db SPRITE_SWIMMER
	db SPRITE_GAMBLER
	db SPRITE_KANGASKHAN ; MONSTER
	db SPRITE_VOLTORB   ; SEEL
	db SPRITE_LAPRAS
	db SPRITE_YOUNGSTER
	db SPRITE_POKE_BALL
	db SPRITE_FOSSIL
