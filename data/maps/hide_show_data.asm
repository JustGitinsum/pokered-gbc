...
Route2HS:
	...
	db ROUTE_2, ROUTE2_TM_THUNDER_WAVE, SHOW
Route4HS:
	db ROUTE_4, ROUTE4_TM_DRAGONBREATH, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_PSYBEAM, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,    SHOW
	db ROUTE_12, ROUTE12_TM_SPORE, SHOW
	db ROUTE_12, ROUTE12_IRON,       SHOW
Route15HS:
	db ROUTE_15, ROUTE15_TM_SIGNAL_BEAM, SHOW
Route16HS:
...
Route25HS:
	db ROUTE_25, ROUTE25_TM_ANCIENTPOWER, SHOW
BluesHouseHS:
...
PokemonTower4FHS:
	...
	db POKEMON_TOWER_4F, POKEMONTOWER4F_FULL_HEAL, SHOW
...
PokemonTower6FHS:
	...
	db POKEMON_TOWER_6F, POKEMONTOWER6F_TM_SHADOW_CLAW, SHOW
PokemonTower7FHS:
...
PowerPlantHS:
	...
	db POWER_PLANT, POWERPLANT_TM_AURA_WHEEL, SHOW
	db POWER_PLANT, POWERPLANT_TM_ENERGY_BALL, SHOW
VictoryRoad2FHS:
	db VICTORY_ROAD_2F, VICTORYROAD2F_MOLTRES,       SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_DRAGON_PULSE, SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_FULL_HEAL,     SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_CLOSE_COMBAT,  SHOW
	db VICTORY_ROAD_2F, VICTORYROAD2F_MAX_ELIXER,    SHOW
...
ViridianForestHS:
	db VIRIDIAN_FOREST, VIRIDIANFOREST_FULL_HEAL,  SHOW
...
MtMoon1FHS:
	...
	db MT_MOON_1F, MTMOON1F_TM_TRAILBLAZE, SHOW
MtMoonB1FHS:
	db MT_MOON_B1F, MTMOONB1F_ONIX, SHOW
MtMoonB2FHS:
...
SSAnneB1FRoomsHS:
	...
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_TM_ICE_FANG,    SHOW
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_HYPER_POTION, SHOW
VictoryRoad3FHS:
	db VICTORY_ROAD_3F, VICTORYROAD3F_MAX_REVIVE,   SHOW
	db VICTORY_ROAD_3F, VICTORYROAD3F_TM_AURA_SPHERE, SHOW
...
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_TM_X_SCISSOR, SHOW
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_SUPER_POTION,  SHOW
RocketHideoutB3FHS:
	db ROCKET_HIDEOUT_B3F, ROCKETHIDEOUTB3F_TM_SLUDGE_BOMB, SHOW
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_AIR_SLASH,  SHOW
...
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_TM_POWER_GEM, SHOW
...
SilphCo7FHS:
	...
	db SILPH_CO_7F, SILPHCO7F_PP_MAX, SHOW
...
SilphCo10FHS:
	...
	db SILPH_CO_10F, SILPHCO10F_TM_EARTH_POWER,  SHOW
...
UnusedMapF4HS:
	db ROUTE_10_FOSSIL_ROOM, $02, SHOW ; unused
PokemonMansion2FHS:
	db POKEMON_MANSION_2F, POKEMONMANSION2F_CALCIUM, SHOW
PokemonMansion3FHS:
	db POKEMON_MANSION_3F, POKEMONMANSION3F_HYPER_POTION, SHOW
...
PokemonMansionB1FHS:
	...
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_POISON_JAB,  SHOW
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_GLACIAL_LANCE, SHOW
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_SECRET_KEY,   SHOW
SafariZoneEastHS:
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_FULL_RESTORE, SHOW
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_HYPER_POTION,  SHOW
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_CARBOS,       SHOW
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_ICE_BEAM,  SHOW
SafariZoneNorthHS:
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_PROTEIN,       SHOW
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_TM_FLAMETHROWER, SHOW
SafariZoneWestHS:
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_HYPER_POTION,     SHOW
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_TM_THUNDERBOLT, SHOW
...
VictoryRoad1FHS:
	db VICTORY_ROAD_1F, VICTORYROAD1F_TM_DRAGON_CLAW, SHOW
...
SeafoamIslandsB2FHS:
	...
	db SEAFOAM_ISLANDS_B2F, SEAFOAMISLANDSB2F_FOSSIL, SHOW
SeafoamIslandsB3FHS:
