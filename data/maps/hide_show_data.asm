...
Route4HS:
	db ROUTE_4, ROUTE4_TM_THIEF, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_BRICK_BREAK, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,    SHOW
	db ROUTE_12, ROUTE12_TM_SIGNAL_BEAM, SHOW
...
VictoryRoad2FHS:
	...
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_EXTREMESPEED, SHOW
...
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_TM_BODY_SLAM, SHOW
...
PokemonMansionB1FHS:
	...
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_ENERGY_BALL, SHOW
