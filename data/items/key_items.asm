KeyItemFlags:
	...
	dbit FALSE ; LINK_STONE (ANTIDOTE)
	dbit FALSE ; DAWN_STONE (BURN_HEAL)
	dbit FALSE ; DUSK_STONE (ICE_HEAL)
	dbit FALSE ; METAL_COAT (AWAKENING)
	dbit FALSE ; RAZOR_FANG (PARLYZ_HEAL)
	...
	dbit TRUE  ; JAW_FOSSIL (GUARD_SPEC)
	dbit FALSE ; SUPER_REPEL
	dbit FALSE ; MAX_REPEL
	dbit TRUE  ; SAIL_FOSSIL (DIRE_HIT)
	dbit FALSE ; COIN
