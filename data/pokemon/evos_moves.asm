...
; Learnset
	...
	db 40, HEAT_CRASH
	db 43, OUTRAGE
	db EVOLUTION_MOVE, EXTREMESPEED
	db 0
...
; Learnset
	...
	db 33, HEADBUTT
	db 44, HYDRO_PUMP
	db EVOLUTION_MOVE, FLASH_CANNON
	db 0
...
; Learnset SV
	...
	db 40, DOUBLE_EDGE
	db 50, HEAT_CRASH
	db EVOLUTION_MOVE, FLAMETHROWER
	db 0
